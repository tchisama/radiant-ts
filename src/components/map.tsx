  ...
  return (
    <div aria-hidden="true" className="relative size-full">
      ...
      <div className="absolute inset-0">
        ...
        <Marker src="/map/1.jpg" top={160} offset={-16} delay={0.4} />
        <Marker src="/map/1.jpg" top={144} offset={96} delay={0.3} />
        <Marker src="/map/1.jpg" top={192} offset={64} delay={0.6} />
        <Marker src="/map/1.jpg" top={224} offset={-32} delay={0.8} />
      </div>
    </div>
  )
}
